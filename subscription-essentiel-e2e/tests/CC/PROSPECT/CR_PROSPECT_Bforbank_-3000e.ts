...
import jdd from '../../../datas/jdd/bforbank.json';
...
test('CR -3000 Bforbank', async ({ page }) => {
  try {
    await page.goto("https://rct.souscription.sofinco.fr/essentiel/?q6=web_sofinco&amount=3000&dueNumber=10&productId=RESERVE+&projectLabel=WORK_DECORATION&idcatorigin=pret_personnel&x1=crs&sourceId=PUB22905")
