...
test('SOF-148815 | CR>3000 prospect',  { tag: ['@sanity', '@tnr'],}, async ({ page }) => {
  try {
      await page.goto(`https://rct.souscription.sofinco.fr/essentiel/?q6=web_sofinco&amount=3200&dueNumber=36&productId=CARTENEW&projectLabel=FAMILY_MOVING&x1=crs&sourceId=ADE01001`, { timeout: 30000 })
 ...
 // await page.getByText("Continuer").nth(3).click();
